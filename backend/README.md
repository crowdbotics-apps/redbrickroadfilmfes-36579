...
## Project Structure
    ...
    ├── redbrickroadfilmfes_36579  # Django project configurations
...
1. Clone this repo and `cd redbrickroadfilmfes_36579`
...
2. Clone this repo and `cd redbrickroadfilmfes_36579`
